...
enum EffectiveHorizontalAlignment: Alignment {
    case left
    case right
    case justified
}

struct AlignmentAxis<A: Alignment> {
...
class AlignedCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    var effectiveHorizontalAlignment: EffectiveHorizontalAlignment {
    ...
    func originalLayoutAttribute(forItemAt indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        return super.layoutAttributesForItem(at: indexPath)
    }
    
    func isFrame(for firstItemAttributes: UICollectionViewLayoutAttributes, inSameLineAsFrameFor secondItemAttributes: UICollectionViewLayoutAttributes) -> Bool {
    ...
    func verticalAlignmentAxis(for currentLayoutAttributes: UICollectionViewLayoutAttributes) -> AlignmentAxis<VerticalAlignment> {
        let layoutAttributesInLine = layoutAttributes(forItemsInLineWith: currentLayoutAttributes)
        if let v = verticalAlignmentAxisForLine(with: layoutAttributesInLine) {
            return v
        }else{
            return AlignmentAxis<VerticalAlignment>(alignment: .center, position: 0)
        }
    }
...
extension UIViewController {
    public func displayDXTagsView(tagsViewContainer view: UIView, contentController content : UIViewController) {
        ...
        view.addConstraints([
            NSLayoutConstraint(item: content.view!, attribute: .top, relatedBy: .equal, toItem: view, attribute: .top, multiplier: 1, constant: 0),
            NSLayoutConstraint(item: content.view!, attribute: .bottom, relatedBy: .equal, toItem: view, attribute: .bottom, multiplier: 1, constant: 0),
            NSLayoutConstraint(item: content.view!, attribute: .leading, relatedBy: .equal, toItem: view, attribute: .leading, multiplier: 1, constant: 0),
            NSLayoutConstraint(item: content.view!, attribute: .trailing, relatedBy: .equal, toItem: view, attribute: .trailing, multiplier: 1, constant: 0)
        ])
    }
    
    
    public func hideDXTagsView(contentController content : UIViewController) {
